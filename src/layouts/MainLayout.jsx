    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <a
                ...
                className="hidden md:flex fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-xl hover:scale-110 hover:bg-green-600 transition-all duration-300 items-center justify-center pulse-animation"
                aria-label="Chat on WhatsApp"
            >
                <span className="hidden md:block mr-2 font-medium">Chat with us</span>
